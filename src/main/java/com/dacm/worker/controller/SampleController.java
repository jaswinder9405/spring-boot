package com.dacm.worker.controller;
...
import com.dacm.worker.constant.UrlConstant;
...
public class SampleController {
	...
	public ResponseEntity<SampleResponse> addSample(
			@RequestHeader(name = UrlConstant.Header.AUTHORIZATION, required = true) String authorizationToken,
